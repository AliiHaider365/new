        ...
        <footer id="contact">
            <div className="pr container-fluid">
              <div className="row w-100 justify-content-center">
                <div className="mx-auto offseted col-sm-7 col-md-7 col-9">
                  <div className="timeline alt"></div> <small className="section-title bullet-title alt">Contact /&gt;</small>
                  <div className="main-footer-wrp">
                    <h2 className="mt-3 pt-3 social-title">Find me on:</h2>
                    <div className="social-wrp w-100 mb-3"><a target="_blank" rel="noopener noreferrer" 
                        href="https://www.linkedin.com/in/janbaszczok/"><svg version="1.1"
                        ...
                        in/jan.baszczok
                      </a> <a target="_blank" rel="noopener noreferrer"  href="https://twitter.com/YasiOnFire"><svg version="1.1"
                          xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                          <path
                        ...
                        @YasiOnFire
                      </a> <a target="_blank" rel="noopener noreferrer" href="https://github.com/YasiOnFire"><svg version="1.1"
                        ...
                        github.com/YasiOnFire
                      </a> <a target="_blank" rel="noopener noreferrer" href="https://codepen.io/Yasio"><svg version="1.1"
                          xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                          <path
                        ...
                        Yasio</a> <a target="_blank" rel="noopener noreferrer"
                        href="https://play.google.com/store/apps/developer?id=YAS.IO"><svg version="1.1"
                          xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                          <path
                        ...
                        YAS.IO
                      </a> <a target="_blank" rel="noopener noreferrer" href="mailto:baszczok@yasio.pl"><svg version="1.1"
                          xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                          <path
                        ...
                        baszczok@yasio.pl
                      </a> <a target="_blank" rel="noopener noreferrer" href="https://vimeo.com/yasio"><svg version="1.1"
                          xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                          <path
                        ...
                        href="https://app.pluralsight.com/profile/jan-baszczok"><svg width="20" height="20"
                        ...
                        Pluralsight
                      </a></div> <Link to={"/subcribe"} className="btn btn-primary">Get in touch<div className="btn2"></div></Link>
                  </div>
                </div >
                <div className="mx-auto copy col-7"><small>© Made with {""}
